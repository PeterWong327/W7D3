...
var PokemonIndex = function (_React$Component) {
  ...
  function PokemonIndex(props) {
    ...
    var _this = _possibleConstructorReturn(this, (PokemonIndex.__proto__ || Object.getPrototypeOf(PokemonIndex)).call(this, props));
  ...
  _createClass(PokemonIndex, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "ul",
        null,
        this.props.allPokemon.map(function (poke) {
          return _react2.default.createElement(
            "li",
            { key: poke.id },
            poke.name,
            " ",
            _react2.default.createElement("img", { src: poke.image_url, width: "100" })
          );
        }),
        " "
      );
...
var _store = __webpack_require__(/*! ./store/store.js */ "./frontend/store/store.js");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  _reactDom2.default.render(_react2.default.createElement(_root2.default, { store: store }), document.getElementById('react-goes-here'));
});
...
var entitiesReducer = (0, _redux.combineReducers)({
  pokemon: _pokemon_reducer2.default //{action.pokemon}
  // items: itemsReducer,
});
...
var rootReducer = (0, _redux.combineReducers)({
  entities: _entities_reducer2.default // {pokemon: action.pokemon}
  // ui: uiReducer,
});
